        ...
        <div className="p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-0 -bottom-5 text-xs text-blue-600 hover:text-blue-500"
                >
                  Forgot password?
                </button>
              </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-3 px-4 rounded-lg font-medium text-white ${loading ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'} transition-colors flex items-center justify-center`}
            >
              {loading ? (
                <>
